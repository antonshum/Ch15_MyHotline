...
public class MainActivity extends AppCompatActivity
            implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener { //宣告實作介面
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(this); // 設定『按下項目』事件的監聽器
        lv.setOnItemLongClickListener(this); //設定『長按項目』事件的監聽器
    ...
    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        onItemClick(parent, view, position, id); //呼叫『選取項目』的事件處理方法
        call(view); //呼叫撥號的方法
        return true; //表示已經處理好，不需再引發後續事件
    }
